...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield octokit.repos.createDeploymentStatus(Object.assign({}, context.repo, { deployment_id: deployment.data.id, description, state: initialStatus, log_url: logUrl, environment_url: url }));
